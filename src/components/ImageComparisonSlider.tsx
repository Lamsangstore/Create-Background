    ...
    <div className="relative group bg-white rounded-2xl overflow-hidden border border-line shadow-studio select-none">
      ...
      >
        ...
        <div className="absolute top-3 left-3 z-20 pointer-events-none">
          <span className="bg-white/85 backdrop-blur-md text-ink text-[16px] font-semibold px-2.5 py-1 rounded-lg border border-line">
            ภาพต้นแบบ (Original)
          </span>
        </div>

        <div className="absolute top-3 right-3 z-20 pointer-events-none">
          <span className="bg-gold text-white text-[16px] font-bold px-2.5 py-1 rounded-lg shadow-md flex items-center gap-1">
      ...
      <div className="p-3 bg-white border-t border-line flex items-center justify-between gap-2">
        <div className="truncate">
          <p className="text-[17px] font-semibold text-ink truncate">{title || 'ภาพผลลัพธ์สตูดิโอ'}</p>
          <p className="text-[16px] text-muted">เลื่อนแถบเพื่อเปรียบเทียบความแตกต่าง</p>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {onDownload && (
            <button
              type="button"
              onClick={onDownload}
              className="btn btn-primary px-3 py-1.5 text-[17px]"
            >
